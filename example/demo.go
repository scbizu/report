...
func main() {
	...
	table := [][][]interface{}{
		{{report.NewText("任务名称")}, {report.NewText("{{task_name}}")}},
		{{report.NewText("扫描模板")}, {report.NewText("{{policy_name}}")}},
		{{report.NewText("Web风险")}, {tdimage1, report.NewText("风险值:6.9")}},
		{{report.NewText("域名统计")}, {report.NewText("已扫描域名数：1 "), report.NewText("非常危险域名：0")}},
		{{report.NewText("信息统计")}, {report.NewText("已扫描的文件：213"), report.NewText("有漏洞的文件：72"), report.NewText("已扫描的链接：216")}},
		{{report.NewText("时间统计")}, {report.NewText("开始：2011-11-09 15:51:00"), report.NewText("结束：2011-11-09 18:08:35"), report.NewText("耗时：2 小时17 分35 秒")}}}
	...
	table = [][][]interface{}{
		{{report.NewText("http://www.xjbtw.com/Article_Class.asp")}, {report.NewText("13")}},
		{{report.NewText("http://www.xjbtw.com/Article_ClassC.asp")}, {report.NewText("8")}},
		{{report.NewText("http://www.xjbtw.com/video_xwlb.asp	")}, {report.NewText("8")}},
		{{report.NewText("http://www.xjbtw.com/video_ttbb.asp")}, {report.NewText("7")}},
		{{report.NewText("http://www.xjbtw.com/imgchange.asp")}, {report.NewText("7")}}}
	...
	table = [][][]interface{}{
		...
		{{report.NewText("http://www.xjbtw.com/video_xwlb.asp	")}, {report.NewText("8")}},
		{{report.NewText("http://www.xjbtw.com/video_ttbb.asp")}, {report.NewText("7")}},
		{{report.NewText("http://www.xjbtw.com/imgchange.asp")}, {report.NewText("6")}}}
	trSpan = []int{0, 0, 0, 0, 0}
	tdw = []int{4190, 4190, 4190, 4190, 4190, 4190, 4190, 4190, 4190, 4190}
	thw = []int{4190, 4190}
	tableObj = report.NewTable(true, table, tableHead, thw, trSpan, tdw)
	...
	table = [][][]interface{}{
		{{intableImage, report.NewText("192.168.168.250")}, {report.NewText("192.168.168.250")}, {report.NewText("1")}, {report.NewText("1")}, {report.NewText("1")}, {report.NewText("1")}, {report.NewText("1")}},
		{{intableImage2, report.NewText("192.168.168.250")}, {report.NewText("192.168.168.250")}, {report.NewText("1")}, {report.NewText("1")}, {report.NewText("7")}, {report.NewText("10")}, {report.NewText("10")}}}
	trSpan = []int{0, 0}
	...
	table = [][][]interface{}{
		{{report.NewText("逻辑攻击类型:功能滥用")}, {report.NewText("0")}, {report.NewText("0")}, {report.NewText("1")}, {report.NewText("1")}},
		{{report.NewText("命令执行类型:SQL注入")}, {report.NewText("1")}, {report.NewText("1")}, {report.NewText("0")}, {report.NewText("0")}},
		{{report.NewText("信息泄露类型:资源位置可预测")}, {report.NewText("0")}, {report.NewText("0")}, {report.NewText("3")}, {report.NewText("3")}},
		{{report.NewText("信息泄露类型:信息泄露")}, {report.NewText("0")}, {report.NewText("0")}, {report.NewText("3")}, {report.NewText("3")}},
		{{report.NewText("其他")}, {report.NewText("0")}, {report.NewText("0")}, {report.NewText("0")}, {report.NewText("1")}}}
	trSpan = []int{0, 0, 0, 0, 0}
	...
	tit := [][][]interface{}{
		{{report.NewText("请求方式")}, {report.NewText("GET")}},
		{{report.NewText("URL")}, {report.NewText(`http://www.xjbtw.com/Link_Class.asp?class_id_int=5`)}},
		{{report.NewText("问题参数")}, {report.NewText("class_id_int")}},
		{{report.NewText("参考（验证）")}, {report.NewText(`http://www.xjbtw.com/Link_Class.asp?class_id_int`)}}}
	...
	table = [][][]interface{}{
		{{redFont}, {report.NewText("1")}, {intableImage3}},
